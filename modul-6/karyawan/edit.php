...
<body class="bg-purple-100 p-10">
    <div class="bg-purple-300 p-6 rounded shadow-md w-full max-w-lg mx-auto">
        <h2 class="text-2xl font-bold mb-4 text-center">Edit Data Absensi</h2>
        <form method="POST" class="space-y-3">
            ...
            <button name="update" class="bg-purple-500 text-white px-4 py-2 rounded hover:bg-purple-600">Update</button>
        </form>
    </div>
</body>
</html>